...
void multiplicative_sum_sample() {
    cout << "=== sum_multiplicative_sample ===" << endl;
    for (int h = 6; h <= 6; h++) {
        auto T0 = clk::now();
        cout << "10^" << h << endl;
...

        {
            ...
            auto ans = sum_multiplicative<int64_t>(s1, f, n, prim.p().data(), (int)prim.p().size());
            cout << "mul_sum ds0(k): " << ans[n] << " " << since(T) << endl;
        }

        {
            ...
            auto ans = sum_multiplicative<int64_t>(s1, f, n, prim.p().data(), (int)prim.p().size());
            cout << "mul_sum ds0(k^2): " << ans[n] << " " << since(T) << endl;
        }

        {
            ...
            auto ans = sum_multiplicative<int64_t>(s1, f, n, prim.p().data(), (int)prim.p().size());
            cout << "mul_sum ds1(k): " << ans[n] << " " << since(T) << endl;
        }

        {
            ...
            auto ans = sum_multiplicative<mod>(s1, f, n, prim.p().data(), (int)prim.p().size());
            cout << "mul_sum ds2(k): " << ans[n].v << " " << since(T) << endl;
        }

        {
            ...
            auto s1 = [&](int64_t n) { return ps1[n] - pi[n]; };
            auto ans = sum_multiplicative<int64_t>(s1, f, n, prim.p().data(), (int)prim.p().size());
            cout << "mul_sum phi(k): " << ans[n] << " " << since(T) << endl;
        }

        {
            ...
            auto ans = sum_multiplicative<int64_t>(s1, f, n, prim.p().data(), (int)prim.p().size());
            cout << "mul_sum mu(k): " << ans[n] << " " << since(T) << endl;
        }

        {
            ...
            auto ans = sum_multiplicative<int64_t>(s1, f, n, prim.p().data(), (int)prim.p().size());
            cout << "mul_sum rad(k): " << ans[n] << " " << since(T) << endl;
        }

        {
            ...
            auto s1 = [&](int64_t n) { return -pi[n]; };
            auto ans = sum_multiplicative<int64_t>(s1, f, n, prim.p().data(), (int)prim.p().size());
            cout << "mul_sum lambda(k): " << ans[n] << " " << since(T) << endl;
        }

        {
            ...
            auto s1 = [&](int64_t n) { return pi[n] * 2; };
            auto ans = sum_multiplicative<int64_t>(s1, f, n, prim.p().data(), (int)prim.p().size());
            cout << "mul_sum 2^nu(k): " << ans[n] << " " << since(T) << endl;
        }

        {
            ...
            auto s1 = [&](int64_t n) { return pi[n] * 2; };
            auto ans = sum_multiplicative<int64_t>(s1, f, n, prim.p().data(), (int)prim.p().size());
            cout << "mul_sum 2^omega(k): " << ans[n] << " " << since(T) << endl;
        }

        {
            ...
            auto ans = sum_multiplicative<mod>(s1, f, n, prim.p().data(), (int)prim.p().size());
            cout << "mul_sum k^2: " << ans[n].v << " " << since(T) << endl;
        }
